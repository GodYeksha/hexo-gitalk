...
! function(e) {
	SearchService = function(t) {
		...
		o.config = e.extend({
			...
			var n = "";
			return n = "<li>", n += "<a class='result' href='" + e + "'>", n += "<span class='title'>" + a + "</span>", "" !== t && (n += "<span class='digest'>" + t + "</span>"), n += "</a>", n += "</li>"
		}, o.close = function() {
			...
			return "" !== o && "" !== n && e.each(r, function(e, t) {
				if (s = o.indexOf(t), c = n.indexOf(t), s < 0 && c < 0 ? i = !1 : (i = !0, c < 0 && (c = 0), 0 === e && (l = c)), i) {
					...
					var d = 0,
						u = 0;
					if (l >= 0) {
						u = 0 === (d = Math.max(l - 40, 0)) ? Math.min(200, n.length) : Math.min(l + 120, n.length);
